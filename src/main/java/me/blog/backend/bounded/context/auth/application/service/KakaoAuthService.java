package me.blog.backend.bounded.context.auth.application.service;
...
import me.blog.backend.bounded.context.auth.port.in.KakaoUseCase;
...
@Service
public class KakaoAuthService implements KakaoUseCase {
    ...
    public KakaoAuthService(JwtTokenProvider jwtTokenProvider, UserRepositoryPort userRepository) {
